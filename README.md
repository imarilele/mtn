> This is a Drupal 9 project with Lando. The project gives you JSON API that list all devices from a custom content type. Postman Demonstration are on the postman folder.
